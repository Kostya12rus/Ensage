...
client.on("friendMessage", (SENDER, MSG) => {
    ...
    if (MSG.toUpperCase().indexOf("!LEVEL") >= 0) {
                    ...
                    if (!ERR) {
                        if (DATA) {
                            if (n > CURRENTLEVEL) {
                                ...
                                client.chatMessage(SENDER, "To get to level " + n + " you will need " + (s - Math.floor(XPNEEDED / 100)) + " sets. That would cost " + parseInt((s - Math.floor(XPNEEDED / 100)) / CONFIG.CARDS.BUY1KEYFORAMOUNTOFSETS * 100) / 100 + " keys.");
                            } else {
        ...
        client.chatMessage(SENDER, "This bot was made from N/A");
